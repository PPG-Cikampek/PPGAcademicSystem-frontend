    ...
    return (
        <div className="bg-gray-50 md:p-8 px-4 py-8 min-h-screen">
            <div className="mx-auto max-w-7xl">
                <div className="flex max-sm:flex-col sm:justify-between items-center gap-2 mb-6">
                    <PortalHeader
                        title="Portal Informasi Pengembang"
                        description="Informasi real-time tentang pengembangan aplikasi."
                    />
                    <Link
                        to="/info-portal/bug-bounty?tab=leaderboard"
                        className="gap-3 mb-6 pl-3 button-primary"
                    >
                        <Megaphone /> Informasi Temuan Bug
                    </Link>
                </div>
