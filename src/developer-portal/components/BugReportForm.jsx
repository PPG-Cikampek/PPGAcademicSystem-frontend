...
const BugReportForm = ({
    ...
    const handleSubmit = async (event) => {
        ...
        // Validate form
        const { isValid, errors: validationErrors, values } = validateBugReport({
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-600 text-sm">
                    Laporkan bug yang Anda temukan. Pastikan untuk memberikan deskripsi yang jelas
                    dan langkah-langkah untuk mereproduksi bug tersebut.
                </p>
            </div>
