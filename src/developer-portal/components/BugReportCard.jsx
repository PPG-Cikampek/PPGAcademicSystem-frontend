    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-start gap-4 mb-2">
                ...
                {/* Title */}
                <h4 className="mb-2 font-medium text-gray-900 line-clamp-1">{report.title}</h4>
            ...
            <p className="mb-3 text-gray-600 text-sm line-clamp-2">{report.description}</p>
            ...
            <div className="flex flex-wrap gap-3 text-gray-500 text-xs">
                ...
                {isAdmin ||
                    (report.reporterName !== auth.userName && (
