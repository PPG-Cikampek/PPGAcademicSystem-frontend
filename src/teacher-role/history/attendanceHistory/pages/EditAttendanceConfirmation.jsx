...
const EditAttendanceConfirmation = () => {
    ...
    const editFields = [
        { name: 'editReason', label: 'Alasan Mengubah Data?', placeholder: 'Karena lupa mengabsen...', type: 'text', required: true },
    ]
                    ...
                    button={
                        <div className="flex flex-col justify-stretch mt-4">
                            <button
                                ...
                                disabled={isLoading}
                            >
                                {isLoading ? (<LoadingCircle>Processing...</LoadingCircle>) : ('Ya')}
                            </button>
                        </div>
                    }
                />
