                                    ...
                                    <div className={`relative w-full`}>
                                        ...
                                        <AnimatePresence>
                                            {showNotesField[
                                                ...
                                                >
                                                    <div
                                                        className={`mt-2 mr-4 rounded-md bg-white  ring-opacity-5`}
                                                    >
                ...
                state.studentList.length !== 0 && (
                    <div className="fixed bottom-16 left-0 right-0 bg-white border-t border-gray-300 p-4 z-10 transition-all">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            >
                                {isLoading ? (
                                    <LoadingCircle>Menyimpan...</LoadingCircle>
                                ) : (
                                    "Simpan"
                                )}
                            </button>
