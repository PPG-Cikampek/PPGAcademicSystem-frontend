    ...
    if (auth.userRole === 'admin') {
        links = [
            ...
            },
            {
                ...
                subOptions: [
                    ...
                    { link: '/academic', label: 'Tahun Ajaran', icon: <CalendarCog /> },
        ...
        links = [
            ...
            // },
            {
                ...
                subOptions: [
                    { link: '/academic', label: 'Tahun Ajaran Desa', icon: <CalendarCog /> },
                    { link: '/munaqasyah', label: 'Munaqosah', icon: <BookOpenText /> },
                ],
            },
        ];
        ...
        links = [
            ...
            // },
            {
                ...
                subOptions: [
                    { link: '/dashboard/teaching-groups', label: 'KBM', icon: <CalendarCog /> },
                    { link: '/munaqasyah', label: 'Munaqosah', icon: <BookOpenText /> },
