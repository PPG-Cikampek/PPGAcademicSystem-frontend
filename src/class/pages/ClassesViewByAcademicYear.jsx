        ...
        <div className="min-h-screen px-4 py-8 md:p-8">
            <div className='max-w-6xl mx-auto'>
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-2xl font-semibold text-gray-900">Pilih Tahun Ajaran</h1>
                </div>
                {isLoading && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-8">
                        {academicYear.map((year) => (
                            <div
                                ...
                                onClick={() => navigate('/dashboard/classes/academic-year/', { state: { classes: year.classes } })}
                            >
                                <div className="flex flex-col">
                                    <h1 className="text-lg md:text-2xl font-medium">{academicYearFormatter(year.academicYearName)}</h1>
                                </div>
                            </div>
                        ))}
                    </div>
