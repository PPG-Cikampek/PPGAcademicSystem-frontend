...
const AcademicYearCard = ({
    ...
    const transformedData =
        Array.isArray(year.branchYears) && year.branchYears.length > 0
    ...
    const columns = [
        ...
        },
        {
            ...
            cellStyle: (item) => {
                if (year.munaqasyahStatus === "notStarted")
                    return "py-1 px-2 rounded-md text-sm text-center w-min italic text-gray-500";
              ...
              ${expanded ? "transform rotate-180" : ""}`}
                ...
                {year.isActive ? (
                    <div className="flex flex-col items-start gap-1">
                        ...
                        <div
                            className={`inline-block mt-2 px-2 py-1 text-sm rounded-sm ${munaqasyahStatusObj.className}`}
                        >
                    ...
                    {year.branchYears.length > 0 ? (
                        <>
                            ...
                            <div className=" flex justify-end">
                                <button
                                    onClick={() => onDelete(year.name, year.id)}
