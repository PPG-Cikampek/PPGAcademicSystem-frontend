            ...
            <main className="max-w-6xl mx-auto">
                <div className="flex md:flex-row flex-wrap justify-between md:justify-start gap-4 md:gap-8">
                    {classGrades.map((grade) => (
                        <Link key={grade.grade} to={`/munaqasyah/question-bank/${grade.grade}`} className='card-interactive justify-start min-h-16 min-w-40 max-w-[10.5rem] md:min-h-40 md:min-w-80 md:max-w-96 rounded-md items-center md:p-8 m-0 gap-4'>
