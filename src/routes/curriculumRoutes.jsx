...
const QuestionDetailView = lazy(() =>
    import("../munaqasyah/pages/QuestionDetailView")
);
const UpdateQuestionView = lazy(() =>
    import("../munaqasyah/pages/UpdateQuestionView")
);
const QuestionPackageView = lazy(() =>
    import("../munaqasyah/pages/QuestionPackageView")
);
...
export const curriculumRoutes = [
    ...
    },
    {
        ...
        element: <QuestionBankView />,
    },
    {
        path: "/munaqasyah/question-bank/:classGrade/new",
        element: <NewQuestionView />,
    },
    {
        path: "/munaqasyah/question-bank/:classGrade/:questionId",
        element: <QuestionDetailView />,
    },
    {
        path: "/munaqasyah/question-bank/:classGrade/:questionId/update",
        element: <UpdateQuestionView />,
    },
